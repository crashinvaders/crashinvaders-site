...
The project is assembled by the [NPM](https://www.npmjs.com/) using the [Webpack](https://webpack.js.org/) bundler with [Pug](https://pugjs.org/api/getting-started.html) page templates.
